{
 ...
 // c1_2->SetLogx();
  ...
  TH1F *h1_ZMass = (TH1F*)f1->Get("elePhi");
  TH1F *h2_ZMass = (TH1F*)f2->Get("elePhi");
  TH1F *h3_ZMass = (TH1F*)f3->Get("elePhi");
  TH1F *h4_ZMass = (TH1F*)f4->Get("elePhi");
  TH1F *h5_ZMass = (TH1F*)f5->Get("elePhi");
  TH1F *h6_ZMass = (TH1F*)f6->Get("elePhi");
  TH1F *h7_ZMass = (TH1F*)f7->Get("elePhi");
  TH1F *h8_ZMass  = (TH1F*)f8->Get("elePhi");
...
//cout << "data = " << h1_ZMass->Integral() << endl;
  ...
  h1ratio->SetTitle("  ");  
  h1ratio->GetXaxis()->SetTitle("Electron #phi");
...
//  c1_1->SetLogx();
  ...
  c1->SaveAs("ElePhi_mcSmeared_PUWeighted.png");
/*
  // *********************************************Z Mass Peak************************
 ...
 TPad *c2_2 = new TPad("c2_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1_ZMassPeak = (TH1F*)f1->Get("elePhi_Peak");
  TH1F *h2_ZMassPeak = (TH1F*)f2->Get("elePhi_Peak");
  TH1F *h3_ZMassPeak = (TH1F*)f3->Get("elePhi_Peak");
  TH1F *h4_ZMassPeak = (TH1F*)f4->Get("elePhi_Peak");
  TH1F *h5_ZMassPeak = (TH1F*)f5->Get("elePhi_Peak");
  TH1F *h6_ZMassPeak = (TH1F*)f6->Get("elePhi_Peak");
  TH1F *h7_ZMassPeak = (TH1F*)f7->Get("elePhi_Peak");
  TH1F *h8_ZMassPeak = (TH1F*)f8->Get("elePhi_Peak");
