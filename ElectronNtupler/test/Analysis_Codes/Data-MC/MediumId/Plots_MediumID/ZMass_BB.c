...
//const char *histo[9] = {"", "DYTT_M10to3000", "WJets", "dieleBkg_2", "dieleBkg_3", "dieleBkg_4", "dieleBkg_5", "dieleBkg_6", "dieleBkg_7"};
 ...
 TPad *c1_2 = new TPad("c1_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1 = (TH1F*)f1->Get("dieleMass_BB");
  TH1F *h2 = (TH1F*)f2->Get("dieleMass_BB");
  TH1F *h3 = (TH1F*)f3->Get("dieleMass_BB");
  TH1F *h4 = (TH1F*)f4->Get("dieleMass_BB");
  TH1F *h5 = (TH1F*)f5->Get("dieleMass_BB");
  TH1F *h6 = (TH1F*)f6->Get("dieleMass_BB");
  TH1F *h7 = (TH1F*)f7->Get("dieleMass_BB");
  TH1F *h8  = (TH1F*)f8->Get("dieleMass_BB");
