{
 ...
 TPad *c1_2 = new TPad("c1_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1 = (TH1F*)f1->Get("dieleMass");
  TH1F *h2 = (TH1F*)f2->Get("dieleMass");
  TH1F *h3 = (TH1F*)f3->Get("dieleMass");
  TH1F *h4 = (TH1F*)f4->Get("dieleMass");
  TH1F *h5 = (TH1F*)f5->Get("dieleMass");
  TH1F *h6 = (TH1F*)f6->Get("dieleMass");
  TH1F *h7 = (TH1F*)f7->Get("dieleMass");
  TH1F *h8  = (TH1F*)f8->Get("dieleMass");
