{
  ...
  TFile *f1 = TFile::Open("SingleElectron_ScaleCorr_new_highMass.root");
  TFile *f2 = TFile::Open("DYEE_M10to3000_new_highMass.root");
  TFile *f3 = TFile::Open("DYTT_M10to3000_new_highMass.root");
  TFile *f4 = TFile::Open("dieleBkg_2_new_highMass.root");
  TFile *f5 = TFile::Open("dieleBkg_3_new_highMass.root");
  TFile *f6 = TFile::Open("dieleBkg_4_new_highMass.root");
  TFile *f7 = TFile::Open("dieleBkg_5_new_highMass.root");
  TFile *f8 = TFile::Open("WJets_new_highMass.root");
//   TFile *f8 = TFile::Open("dieleBkg_1_new.root");
 ...
 TPad *c1_2 = new TPad("c1_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1_ZMass = (TH1F*)f1->Get("elePT");
  TH1F *h2_ZMass = (TH1F*)f2->Get("elePT");
  TH1F *h3_ZMass = (TH1F*)f3->Get("elePT");
  TH1F *h4_ZMass = (TH1F*)f4->Get("elePT");
  TH1F *h5_ZMass = (TH1F*)f5->Get("elePT");
  TH1F *h6_ZMass = (TH1F*)f6->Get("elePT");
  TH1F *h7_ZMass = (TH1F*)f7->Get("elePT");
  TH1F *h8_ZMass  = (TH1F*)f8->Get("elePT");
