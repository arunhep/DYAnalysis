{
  ...
  TFile *f8 = TFile::Open("WJets_new.root");
//   TFile *f8 = TFile::Open("dieleBkg_1_new.root");
 ...
 TPad *c1_2 = new TPad("c1_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1_ZMass = (TH1F*)f1->Get("dieleMass");
  TH1F *h2_ZMass = (TH1F*)f2->Get("dieleMass");
  TH1F *h3_ZMass = (TH1F*)f3->Get("dieleMass");
  TH1F *h4_ZMass = (TH1F*)f4->Get("dieleMass");
  TH1F *h5_ZMass = (TH1F*)f5->Get("dieleMass");
  TH1F *h6_ZMass = (TH1F*)f6->Get("dieleMass");
  TH1F *h7_ZMass = (TH1F*)f7->Get("dieleMass");
  TH1F *h8_ZMass  = (TH1F*)f8->Get("dieleMass");
...
//  cout<<"No Masking"<<endl;
  ...
  for(int i=1; i<nbins+1; i++){
   ...
   cout<<"data: "<<h1_ZMass->GetBinContent(i)<< endl << "Total MC: "<<h1_mc->GetBinContent(i)<<endl << "Ratio = " << h1_ZMass->GetBinContent(i)/h1_mc->GetBinContent(i) << endl << "DYEE = " << h2_ZMass->GetBinContent(i) << endl << "DYTauTau = " << h3_ZMass->GetBinContent(i) << endl << "ttbar = " << h4_ZMass->GetBinContent(i) << endl << "diBoson = " << h_diBoson_ZMass->GetBinContent(i) << endl << "WJets = " << h8_ZMass->GetBinContent(i) << endl; 
cout <<"*****************************" << endl;
  }
  ...
  h1ratio->GetYaxis()->SetRangeUser(0,2.5);
  ...
  c1->SaveAs("ZMass_PUWeighted_76X_TruncateSamples.png");
/*
  // *********************************************Z Mass Peak************************
 ...
 TPad *c2_2 = new TPad("c2_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1_ZMassPeak = (TH1F*)f1->Get("dieleMass_Peak");
  TH1F *h2_ZMassPeak = (TH1F*)f2->Get("dieleMass_Peak");
  TH1F *h3_ZMassPeak = (TH1F*)f3->Get("dieleMass_Peak");
  TH1F *h4_ZMassPeak = (TH1F*)f4->Get("dieleMass_Peak");
  TH1F *h5_ZMassPeak = (TH1F*)f5->Get("dieleMass_Peak");
  TH1F *h6_ZMassPeak = (TH1F*)f6->Get("dieleMass_Peak");
  TH1F *h7_ZMassPeak = (TH1F*)f7->Get("dieleMass_Peak");
  TH1F *h8_ZMassPeak = (TH1F*)f8->Get("dieleMass_Peak");
