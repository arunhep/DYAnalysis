...
void mc13TeV_WJets() {
  ...
  double xsec[7] = {1347,360,48.9,12.8,5.26,1.33,0.03089};
  double sumofWts[7] = {10205377,4949568,1721402,3330270,1406916,246239,251982};
  ...
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_100_200.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_200_400.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_400_600.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_600_800.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_800_1200.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_1200_2500.root"));
  InputFiles_bkg.push_back(TFile::Open(workdir+"Wjets_HT_2500_Inf.root"));
 ...
 for(unsigned int jentry = 0; jentry < 1; ++jentry) { 
    ...
    file[jentry] = new TFile(Form("MediumId_Calibrated/WJets_%d.root",bkg[jentry]),"RECREATE");
