{
 ...
 // c1_2->SetLogx();
  ...
  h1ratio->SetTitle("  ");  
  h1ratio->GetXaxis()->SetTitle("Electron PT [GeV]");
...
//  c1_1->SetLogx();
  ...
  c1->SaveAs("ElePT_mcSmeared_PUWeighted.png");
/*
  // *********************************************Z Mass Peak************************
 ...
 TPad *c2_2 = new TPad("c2_2","newpad",0.008032129,0.1866667,0.9879518,0.9911111);
  ...
  TH1F *h1_ZMassPeak = (TH1F*)f1->Get("elePT_Peak");
  TH1F *h2_ZMassPeak = (TH1F*)f2->Get("elePT_Peak");
  TH1F *h3_ZMassPeak = (TH1F*)f3->Get("elePT_Peak");
  TH1F *h4_ZMassPeak = (TH1F*)f4->Get("elePT_Peak");
  TH1F *h5_ZMassPeak = (TH1F*)f5->Get("elePT_Peak");
  TH1F *h6_ZMassPeak = (TH1F*)f6->Get("elePT_Peak");
  TH1F *h7_ZMassPeak = (TH1F*)f7->Get("elePT_Peak");
  TH1F *h8_ZMassPeak = (TH1F*)f8->Get("elePT_Peak");
